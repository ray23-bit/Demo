...
document.addEventListener('DOMContentLoaded', function() {
    ...
    enhancePromptBtn.addEventListener('click', async () => {
        ...
        enhancePromptBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> Enhancing...';
        ...
        try {
            const response = await fetch("https://text.pollinations.ai/openai", {
                ...
                body: JSON.stringify({
                    model: "gpt-3.5-turbo",
                    messages: [
                        { role: "system", content: "You are a prompt enhancer for image generation." },
            ...
            showNotification('Error enhancing prompt', 'error');
        } finally {
            enhancePromptBtn.disabled = false;
            enhancePromptBtn.innerHTML = '<i class="fas fa-bolt"></i> Enhance Prompt';
        }
    });
